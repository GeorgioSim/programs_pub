...
[kx, n_plus,n_minus, kx_max, n_max,n_min] = nfinder(omega);
...
function [kx, n_plus,n_minus, kx_max, n_max,n_min] = nfinder(o)
...
n_plus = sqrt(kx)./k0.* sqrt(1i - kx);
n_minus = -sqrt(kx)./k0.* sqrt(1i - kx);
